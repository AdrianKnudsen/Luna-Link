      ...
      <div className={styles.overflow}>
        ...
        <div className={styles.aboutPage}>
          ...
          <p className={styles.introText}>
            ❝At Luna Link were more than just a forum. We are a thriving
            community built on shared interests, open discussions, and the
          ...
          <div className={styles.section}>
            <h2>Our Mission</h2>
            <p className={styles.introText}>
              Luna Link was founded with a simple yet powerful mission: to
              create a space where individuals from diverse backgrounds can come
          ...
          <div className={styles.section}>
            ...
            <p className={styles.introText}>
              ...
              projects take shape. Join us on this exciting journey as we
              continue to evolve and grow together.
            </p>
          </div>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.introText}>
              ...
              community members. Your voice matters, and were excited to have
              you as part of our community.
            </p>
          </div>

          <p className={styles.endingText}>
            Thank you for being a crucial part of Luna Link. Lets make this
            space a home for engaging discussions, shared experiences, and
            lasting connections.
          </p>
